...
const handleScroll = () => {
  ...
  if (mediaQueryListAndroid.matches) {
    ...
    elements.titleDaerah.style.fontSize= isPast2500 ? "3em" : "";
    ...
    // elements.titleDaerah.style.transform = isPast2500 ? "translateY(100px)" : "";
  }
  ...
  //   if(x.matches){
  //     elements.titleDaerah.style.transform = isPast2500 ? "translateY(300px)" : "";
  //   }else{
  //     elements.titleDaerah.style.transform = isPast2500 ? "translateY(100px)" : "";
  //   }
  // };
...
function updateContent() {
  select(".title-text-daerah").innerHTML =
    dataDaerah[currentIndex][0];
  select(".section1 > img").src = dataDaerah[currentIndex][1];
  select(".text-daerah").innerHTML =
    dataDaerah[currentIndex][2];
    select(".section2").style.backgroundImage = `url('${dataDaerah[currentIndex][3]}')`;
  ...
  select(".section3").style.backgroundImage = `url('${dataDaerah[currentIndex][7]}')`;
  ...
  select(".section4").style.backgroundImage = `url('${dataDaerah[currentIndex][11]}')`;
  ...
  select(".section5").style.backgroundImage = `url('${dataDaerah[currentIndex][15]}')`;
